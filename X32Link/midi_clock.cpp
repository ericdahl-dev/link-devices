...
// USB product string a DAW lists this device under. Renamed from "X32MidiClock"
// when that sketch was retired (LNK-024); safe to change only because no units
// are in users' hands — a saved MIDI port would otherwise re-appear as new.
USBMIDI MidiUSB("X32Link");
