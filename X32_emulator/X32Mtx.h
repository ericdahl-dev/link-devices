...
static const X32command Xmtx01_flash[] = {
...
X32command *Xmtx01 = NULL;
const int Xmtx01_max = sizeof(Xmtx01_flash) / sizeof(X32command);


static const X32command Xmtx02_flash[] = {
		{"/mtx",								{BSCO}, F_FND, {0}, NULL},
...
X32command *Xmtx02 = NULL;
const int Xmtx02_max = sizeof(Xmtx02_flash) / sizeof(X32command);


static const X32command Xmtx03_flash[] = {
		{"/mtx",								{BSCO}, F_FND, {0}, NULL},
...
X32command *Xmtx03 = NULL;
const int Xmtx03_max = sizeof(Xmtx03_flash) / sizeof(X32command);


static const X32command Xmtx04_flash[] = {
		{"/mtx",								{BSCO}, F_FND, {0}, NULL},
...
X32command *Xmtx04 = NULL;
const int Xmtx04_max = sizeof(Xmtx04_flash) / sizeof(X32command);


static const X32command Xmtx05_flash[] = {
		{"/mtx",								{BSCO}, F_FND, {0}, NULL},
...
X32command *Xmtx05 = NULL;
const int Xmtx05_max = sizeof(Xmtx05_flash) / sizeof(X32command);


static const X32command Xmtx06_flash[] = {
		{"/mtx",								{BSCO}, F_FND, {0}, NULL},
...
X32command *Xmtx06 = NULL;
const int Xmtx06_max = sizeof(Xmtx06_flash) / sizeof(X32command);
