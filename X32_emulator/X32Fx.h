...
static const X32command Xfx1_flash[] = {
...
X32command *Xfx1 = NULL;
const int Xfx1_max = sizeof(Xfx1_flash) / sizeof(X32command);


static const X32command Xfx2_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx2 = NULL;
const int Xfx2_max = sizeof(Xfx2_flash) / sizeof(X32command);


static const X32command Xfx3_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx3 = NULL;
const int Xfx3_max = sizeof(Xfx3_flash) / sizeof(X32command);


static const X32command Xfx4_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx4 = NULL;
const int Xfx4_max = sizeof(Xfx4_flash) / sizeof(X32command);


static const X32command Xfx5_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx5 = NULL;
const int Xfx5_max = sizeof(Xfx5_flash) / sizeof(X32command);


static const X32command Xfx6_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx6 = NULL;
const int Xfx6_max = sizeof(Xfx6_flash) / sizeof(X32command);


static const X32command Xfx7_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx7 = NULL;
const int Xfx7_max = sizeof(Xfx7_flash) / sizeof(X32command);


static const X32command Xfx8_flash[] = {
		{"/fx",						{FXTYP1}, F_FND, {0}, NULL},
...
X32command *Xfx8 = NULL;
const int Xfx8_max = sizeof(Xfx8_flash) / sizeof(X32command);
