...
static const X32command Xconfig_flash[] = {
...
X32command *Xconfig = NULL;
const int Xconfig_max = sizeof(Xconfig_flash) / sizeof(X32command);

static const X32command Xmain_flash[] = {
...
X32command *Xmain = NULL;
const int Xmain_max = sizeof(Xmain_flash) / sizeof(X32command);
