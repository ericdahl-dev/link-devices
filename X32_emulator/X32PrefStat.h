...
static const X32command Xprefs_flash[] = {
...
X32command *Xprefs = NULL;
const int Xprefs_max = sizeof(Xprefs_flash) / sizeof(X32command);


static const X32command Xstat_flash[] = {
...
X32command *Xstat = NULL;
const int Xstat_max = sizeof(Xstat_flash) / sizeof(X32command);



static const X32command Xaction_flash[] = {
...
X32command *Xaction = NULL;
const int Xaction_max = sizeof(Xaction_flash) / sizeof(X32command);


static const X32command Xurec_flash[] = {
...
X32command *Xurec = NULL;
const int Xurec_max = sizeof(Xurec_flash) / sizeof(X32command);
