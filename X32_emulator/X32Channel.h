...
static const X32command Xchannel01_flash[] = {
...
X32command *Xchannel01 = NULL;
const int Xchannel01_max = sizeof(Xchannel01_flash) / sizeof(X32command);


static const X32command Xchannel02_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel02 = NULL;
const int Xchannel02_max = sizeof(Xchannel02_flash) / sizeof(X32command);


static const X32command Xchannel03_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel03 = NULL;
const int Xchannel03_max = sizeof(Xchannel03_flash) / sizeof(X32command);


static const X32command Xchannel04_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel04 = NULL;
const int Xchannel04_max = sizeof(Xchannel04_flash) / sizeof(X32command);


static const X32command Xchannel05_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel05 = NULL;
const int Xchannel05_max = sizeof(Xchannel05_flash) / sizeof(X32command);


static const X32command Xchannel06_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel06 = NULL;
const int Xchannel06_max = sizeof(Xchannel06_flash) / sizeof(X32command);


static const X32command Xchannel07_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel07 = NULL;
const int Xchannel07_max = sizeof(Xchannel07_flash) / sizeof(X32command);


static const X32command Xchannel08_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel08 = NULL;
const int Xchannel08_max = sizeof(Xchannel08_flash) / sizeof(X32command);


static const X32command Xchannel09_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel09 = NULL;
const int Xchannel09_max = sizeof(Xchannel09_flash) / sizeof(X32command);


static const X32command Xchannel10_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel10 = NULL;
const int Xchannel10_max = sizeof(Xchannel10_flash) / sizeof(X32command);


static const X32command Xchannel11_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel11 = NULL;
const int Xchannel11_max = sizeof(Xchannel11_flash) / sizeof(X32command);


static const X32command Xchannel12_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel12 = NULL;
const int Xchannel12_max = sizeof(Xchannel12_flash) / sizeof(X32command);


static const X32command Xchannel13_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel13 = NULL;
const int Xchannel13_max = sizeof(Xchannel13_flash) / sizeof(X32command);


static const X32command Xchannel14_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel14 = NULL;
const int Xchannel14_max = sizeof(Xchannel14_flash) / sizeof(X32command);


static const X32command Xchannel15_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel15 = NULL;
const int Xchannel15_max = sizeof(Xchannel15_flash) / sizeof(X32command);


static const X32command Xchannel16_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel16 = NULL;
const int Xchannel16_max = sizeof(Xchannel16_flash) / sizeof(X32command);


static const X32command Xchannel17_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel17 = NULL;
const int Xchannel17_max = sizeof(Xchannel17_flash) / sizeof(X32command);


static const X32command Xchannel18_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel18 = NULL;
const int Xchannel18_max = sizeof(Xchannel18_flash) / sizeof(X32command);


static const X32command Xchannel19_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel19 = NULL;
const int Xchannel19_max = sizeof(Xchannel19_flash) / sizeof(X32command);


static const X32command Xchannel20_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel20 = NULL;
const int Xchannel20_max = sizeof(Xchannel20_flash) / sizeof(X32command);


static const X32command Xchannel21_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel21 = NULL;
const int Xchannel21_max = sizeof(Xchannel21_flash) / sizeof(X32command);


static const X32command Xchannel22_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel22 = NULL;
const int Xchannel22_max = sizeof(Xchannel22_flash) / sizeof(X32command);


static const X32command Xchannel23_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel23 = NULL;
const int Xchannel23_max = sizeof(Xchannel23_flash) / sizeof(X32command);


static const X32command Xchannel24_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel24 = NULL;
const int Xchannel24_max = sizeof(Xchannel24_flash) / sizeof(X32command);


static const X32command Xchannel25_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel25 = NULL;
const int Xchannel25_max = sizeof(Xchannel25_flash) / sizeof(X32command);


static const X32command Xchannel26_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel26 = NULL;
const int Xchannel26_max = sizeof(Xchannel26_flash) / sizeof(X32command);


static const X32command Xchannel27_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel27 = NULL;
const int Xchannel27_max = sizeof(Xchannel27_flash) / sizeof(X32command);


static const X32command Xchannel28_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel28 = NULL;
const int Xchannel28_max = sizeof(Xchannel28_flash) / sizeof(X32command);


static const X32command Xchannel29_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel29 = NULL;
const int Xchannel29_max = sizeof(Xchannel29_flash) / sizeof(X32command);


static const X32command Xchannel30_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel30 = NULL;
const int Xchannel30_max = sizeof(Xchannel30_flash) / sizeof(X32command);


static const X32command Xchannel31_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel31 = NULL;
const int Xchannel31_max = sizeof(Xchannel31_flash) / sizeof(X32command);


static const X32command Xchannel32_flash[] = {
		{"/ch",							{CHCO}, F_FND, {0}, NULL},
...
X32command *Xchannel32 = NULL;
const int Xchannel32_max = sizeof(Xchannel32_flash) / sizeof(X32command);
